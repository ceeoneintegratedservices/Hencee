      ...
      case 'products':
        return (
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24">
            <path d="M21.12 9.88005C21.12 15.9201 15.92 20.7601 9.87 20.7601C3.82 20.7601 1.5 16.8501 1.5 10.8101C1.5 4.77005 3.82 0.850049 9.87 0.850049C15.92 0.850049 21.12 3.84005 21.12 9.88005Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
